  ...
  const barChartEl = document.querySelector('#barChart'),
    barChartConfig = {
      ...
      series: [
        {
          name: 'Not Started',
          data: notStartedUpdate
        },
        {
          name: 'In Progress',
          data: inProgressUpdate
        },
        {
          name: 'Completed',
      ...
      tooltip: {
        ...
        x: {
          ...
          formatter: function (val) {
            return new Date(val).toLocaleDateString(); // Format x-axis value as date
          }
        },
        y: {
          show: true,
          ...
          dataLabels: {
            ...
            total: {
              ...
              formatter: function (w) {
                return completedStatus['percentage'] + '%';
              }
            }
          }
        }
