  ...
  <div class="container">
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4">
      ...
      <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4">
        ...
        <a href="{{url('')}}#landingHero" class="app-brand-link">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        @if (Auth::check())
        <li>
          <a href="{{url('/pages/profile-user')}}" class="btn btn-primary"><span class="tf-icons ti ti-login scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Member Area</span></a>
        </li>
        @else
        <li>
          <a href="{{url('/login')}}" class="btn btn-primary"><span class="tf-icons ti ti-login scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Login</span></a>
        </li>
        @endif
        <!-- navbar button: End -->
      </ul>
